...
1. How much performance improvement can be achieved through feature engineering?
2. Which models benefit the most from engineered features?
3. Which models are most suitable for predicting housing prices in this dataset?
